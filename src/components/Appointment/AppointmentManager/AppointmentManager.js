...
const AppointmentManager = () => {
    ...
    useEffect(() => {
        fetch('https://ancient-crag-54960.herokuapp.com/allAppointment')
            .then(res => res.json())
    ...
    const onSubmit = () => {
        ...
        fetch(`https://ancient-crag-54960.herokuapp.com/update/${editAppointmentId}`, {
            method: 'PATCH',
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <select className="form-select" onChange={(e) => setOrderStatus(e.target.value)} required >
                                                <option selected value="Not set" >Select Status</option>
